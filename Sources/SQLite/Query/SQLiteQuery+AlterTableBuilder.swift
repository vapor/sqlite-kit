...
//            fatalError()
////            self.alter = .init(table: Table.sqliTableName, value: .rename(Table.sqliteTableName.name))
...
//        ) -> Self {
//            return addColumn(.init(name: keyPath.sqlColumnName.name, typeName: typeName, constraints: constraints))
//        }
//        
//        /// Adds a new column to the table. Only one column can be added per `ALTER` statement.
//        ///
