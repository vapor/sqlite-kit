...
extension SQLiteSerializer {
    func serialize(_ join: SQLiteQuery.JoinClause, _ binds: inout [SQLiteData]) -> String {
        var sql: [String] = []
    ...
    func serialize(_ join: SQLiteQuery.JoinClause.Join, _ binds: inout [SQLiteData]) -> String {
        var sql: [String] = []
        if join.natural {
            sql.append("NATURAL")
        }
    ...
    func serialize(_ constraint: SQLiteQuery.JoinClause.Join.Constraint, _ binds: inout [SQLiteData]) -> String {
        var sql: [String] = []
        switch constraint {
    ...
    func serialize(_ op: SQLiteQuery.JoinClause.Join.Operator) -> String {
        switch op {
