...
extension SQLiteSerializer {
    func serialize(_ constraint: SQLiteQuery.TableConstraint, _ binds: inout [SQLiteData]) -> String {
        var sql: [String] = []
    ...
    func serialize(_ value: SQLiteQuery.TableConstraint.Value, _ binds: inout [SQLiteData]) -> String {
        var sql: [String] = []
        switch value {
